...
public final class MessageSenderConstant {
     ...
     */
    public static final String TEMPLATE_REGISTER_ZH_HANS = "";

    /**
     * 注册账号模版
     * <pre>您正在修改账号密码，您的验证码是{1}，识别码是{2}。请核对识别码后再输入验证码，有效期30分钟。</pre>
     */
    public static final String TEMPLATE_CHANGE_PASSWORD_ZH_HANS = "";

    /**
     * 注册账号模版
     * <pre>您正在修改绑定的手机号，您的验证码是{1}，识别码是{2}。请核对识别码后再输入验证码，有效期30分钟。</pre>
     */
    public static final String TEMPLATE_CHANGE_PHONE_ZH_HANS = "";
